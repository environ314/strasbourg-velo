  ...
  useEffect(() => {
    const vegaSpec: VlSpec = {
      ...
      "transform": [
        ...
        { "timeUnit": "hours", "field": "shifted_time", "as": "hour" },
        {
          "aggregate": [
        ...
        {
          "calculate": "datum.id === datum.first_id ? datum.passage_creneau_par_compteur / datum.passage_creneau : 1 - datum.passage_creneau_par_compteur / datum.passage_creneau",
          "as": "rate_brut"
        },
