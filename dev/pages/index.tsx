...
export default function AllCounters({ counts, buildTime }: Props) {
  ...
  return (
    <>
      <Head>
        <title>Compteurs vélo à Strasbourg</title>
      ...
      <div className="p-4">
        ...
        <h1>Compteurs vélo à Strasbourg</h1>
      ...
      <div className="pt-8 text-sm w-1/2">
        <p>
          Source :{' '}
          <a href="https://data.strasbourg.eu/explore/dataset/sirac_flux_trafic/information/">
            données ouvertes de la ville de Strasbourg
          </a>{' '}
